define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'rank_thanks_official/index' + location.search,
                    add_url: 'rank_thanks_official/add',
                    edit_url: 'rank_thanks_official/edit',
                    del_url: 'rank_thanks_official/del',
                    multi_url: 'rank_thanks_official/multi',
                    table: 'rank_thanks_official',
                }
            });
