define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'guide_official/index' + location.search,
                    add_url: 'guide_official/add',
                    edit_url: 'guide_official/edit',
                    del_url: 'guide_official/del',
                    multi_url: 'guide_official/multi',
                    table: 'guide_official',
                }
            });
