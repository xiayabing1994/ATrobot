<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"/www/wwwroot/robot/public/../application/admin/view/card/add.html";i:1558611275;s:61:"/www/wwwroot/robot/application/admin/view/layout/default.html";i:1557482264;s:58:"/www/wwwroot/robot/application/admin/view/common/meta.html";i:1557482264;s:60:"/www/wwwroot/robot/application/admin/view/common/script.html";i:1557482264;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-card_no" data-rule="required" class="form-control" name="row[card_no]" value="<?php echo mkCardNo(); ?>" readonly="readonly" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-bind_host" data-rule="" class="form-control" name="row[bind_host]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-operate" data-rule="required" class="form-control" name="row[operate]" value="<?php echo \think\Session::get('admin.username'); ?>" readonly='readonly' type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Comment'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-comment" data-rule="" class="form-control" name="row[comment]" type="text">
        </div>
    </div>
