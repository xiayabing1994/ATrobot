<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"/www/wwwroot/robot/public/../application/admin/view/card/edit.html";i:1558856015;s:61:"/www/wwwroot/robot/application/admin/view/layout/default.html";i:1557482264;s:58:"/www/wwwroot/robot/application/admin/view/common/meta.html";i:1557482264;s:60:"/www/wwwroot/robot/application/admin/view/common/script.html";i:1557482264;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-expire_time" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" <?php echo \think\Session::get('admin.username')!='admin' ? 'readonly':''; ?> data-use-current="true" name="row[expire_time]" type="text" value="<?php echo $row['expire_time']?datetime($row['expire_time']):''; ?>">
        </div>
    </div>
    <div class="form-group">
