<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/www/wwwroot/robot/public/../application/admin/view/dashboard/index.html";i:1558949920;s:61:"/www/wwwroot/robot/application/admin/view/layout/default.html";i:1557482264;s:58:"/www/wwwroot/robot/application/admin/view/common/meta.html";i:1557482264;s:60:"/www/wwwroot/robot/application/admin/view/common/script.html";i:1557482264;}*/ ?>
<!DOCTYPE html>
...
-->
                    <div class="col-lg-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header"><h3 class="box-title"><?php echo __('邀请码统计'); ?></h3></div>
                            <div class="box-body" style="padding-top:0;">
                                <table class="table table-striped">
                                    <tbody>
                                      ...
                                      <?php if(is_array($totalInvite) || $totalInvite instanceof \think\Collection || $totalInvite instanceof \think\Paginator): $i = 0; $__LIST__ = $totalInvite;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$invite): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td width="140"><?php echo $invite['p_code']; ?></td>
                                        <td><?php echo $invite['count']; ?></td>
                                    </tr>
