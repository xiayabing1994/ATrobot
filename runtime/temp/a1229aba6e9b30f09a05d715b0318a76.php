...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Response'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-response" data-rule="required" class="form-control" name="row[response]" type="text" value="<?php echo htmlentities($row['response']); ?>">
        </div>
    </div>
    <div class="form-group">
