<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"/www/wwwroot/robot/public/../application/index/view/user/responseadd.html";i:1558422696;s:61:"/www/wwwroot/robot/application/index/view/layout/default.html";i:1559025855;s:58:"/www/wwwroot/robot/application/index/view/common/meta.html";i:1558950519;s:61:"/www/wwwroot/robot/application/index/view/common/sidenav.html";i:1559376703;s:60:"/www/wwwroot/robot/application/index/view/common/script.html";i:1557482264;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 class="page-header"><?php echo __('添加自定义回复'); ?></h2>
<form  class="form-horizontal nice-validator n-default n-bootstrap" role="form" data-toggle="validator" method="POST" action="<?php echo url('user/responseadd'); ?>" novalidate="novalidate">

    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">关键字:</label>
        <div class="col-xs-12 col-sm-8">
            <input  class="form-control" data-rule='required' name="keyword" type="text">
        </div>
     </div>
   <div class="form-group">
         <label class="control-label col-xs-12 col-sm-2">回复:</label>
        <div class="col-xs-12 col-sm-8">
            <input  class="form-control" data-rule='required' name="response" type="text">
        </div>
     </div>
        <div class="col-xs-12 col-sm-8">
